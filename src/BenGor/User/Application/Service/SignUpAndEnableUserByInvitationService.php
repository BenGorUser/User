...
/**
 * Sign up and enable user by invitation service class.
 *
 * @author Beñat Espiña <benatespina@gmail.com>
 */
final class SignUpAndEnableUserByInvitationService implements ApplicationService
{
    /**
     * The user repository.
     *
    ...
    public function execute($request = null)
    {
        ...
        return new SignUpAndEnableUserByInvitationResponse($user);
    }
}
