...
/**
 * Sign up user and enable user service class.
 *
 * @author Beñat Espiña <benatespina@gmail.com>
 * @author Gorka Laucirica <gorka.lauzirika@gmail.com>
 */
final class SignUpAndEnableUserService implements ApplicationService
{
    /**
     * The user repository.
     *
    ...
    public function execute($request = null)
    {
        ...
        return new SignUpAndEnableUserResponse($user);
    }
}
