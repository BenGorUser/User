...
/**
 * Spec file of sign up user by invitation response class.
 *
 * @author Beñat Espiña <benatespina@gmail.com>
 */
class SignUpUserByInvitationResponseSpec extends ObjectBehavior
{
    function it_creates_response()
    {
        ...
        $this->shouldHaveType(SignUpUserByInvitationResponse::class);
