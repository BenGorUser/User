...
use BenGor\User\Application\Service\SignUpAndEnableUserResponse;
...
/**
 * Spec file of sign up and enable user service class.
 *
 * @author Beñat Espiña <benatespina@gmail.com>
 * @author Gorka Laucirica <gorka.lauzirika@gmail.com>
 */
class SignUpAndEnableUserServiceSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SignUpAndEnableUserService::class);
    }
    ...
    {
        $request = new SignUpAndEnableUserRequest('user@user.com', 'plainPassword', ['ROLE_USER']);
        ...
        $this->execute($request)->shouldReturnAnInstanceOf(SignUpAndEnableUserResponse::class);
    }
